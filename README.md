...
```
### 3) *API Usage & Testing*
Personally i used Postman for requests, so it should also work on curl, so let`s start
...
- **Migrations** path : **auth-api/src/main/resources/db/changelog/db.changelog-master.yaml**
